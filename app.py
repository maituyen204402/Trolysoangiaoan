...
<div class="main-header">
    ...
    <p>Tác giả: Mai Đức Tuyển- Trường PTDTBT Tiểu học Sủng Thài - ĐT: 0333204402</p>
</div>
""", unsafe_allow_html=True)
    ...
    if not api_key: st.toast("Thiếu API Key!", icon="❌")
        ...
        try:
            with st.spinner('AI đang soạn giáo án (Times New Roman 14pt, A4, Căn lề chuẩn)...'):
                ...
                * Nội dung tích hợp (VD: Học thông qua chơi, Công dân số, Bình đẳng giới)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Mai Đức Tuyển - Trường PTDTBT Tiểu học Sủng Thài - ĐT: 0333204402</div>", unsafe_allow_html=True)
